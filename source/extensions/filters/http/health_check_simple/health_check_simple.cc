...
Http::FilterHeadersStatus HealthCheckSimpleFilter::decodeHeaders(Http::RequestHeaderMap& headers, bool) {
...
Http::FilterTrailersStatus HealthCheckSimpleFilter::decodeTrailers(Http::RequestTrailerMap&) {
